...
MAX_ORDER_SIZE = {
    ...
    # Heat 3
    'BLU': 10000, 'RED': 10000, 'GRN': 10000,
    # Heat 4
    'WDY': 10000, 'BZZ': 10000, 'BNN': 10000,
    # Heat 5
    'VNS': 10000, 'MRS': 10000, 'JPTR': 10000, 'STRN': 10000,
}
...
UNWIND_TICKER_PROFILE = {
    ...
    # Heat 2
    # TRNT: medium liquidity / high vol -> unwind faster, more aggressive.
    'TRNT': {
        'risk_mult': 1.3,
        'base_participation': 0.15,
        'max_participation': 0.35,
        'normal_limit_min_clip': 1000,
        'soft_be_urgency': 0.8,
        'soft_be_slippage': 0.03,
        'soft_be_batch_fraction': 0.45,
        'marketable_limit_eps': 0.015,
    },
    # MTRL: low liquidity / low vol -> unwind carefully, strict on price.
    'MTRL': {
        'risk_mult': 0.8,
        'base_participation': 0.05,
        'max_participation': 0.18,
        'normal_limit_min_clip': 500,
        'soft_be_urgency': 1.8,
        'soft_be_slippage': 0.01,
        'soft_be_batch_fraction': 0.20,
        'marketable_limit_eps': 0.005,
    },
    # Heat 3
    # BLU: high liquidity / high vol -> unwind fast, tolerate price drift.
    'BLU': {
        'risk_mult': 1.3,
        'base_participation': 0.18,
        'max_participation': 0.40,
        'normal_limit_min_clip': 1500,
        'soft_be_urgency': 0.7,
        'soft_be_slippage': 0.04,
        'soft_be_batch_fraction': 0.55,
        'marketable_limit_eps': 0.02,
    },
    # RED: medium liquidity / low vol -> unwind smooth, strict on price.
    'RED': {
        'risk_mult': 0.8,
        'base_participation': 0.06,
        'max_participation': 0.22,
    ...
    # GRN: medium liquidity / medium vol -> balanced approach.
    'GRN': {
        'risk_mult': 1.0,
        'base_participation': 0.10,
        'max_participation': 0.28,
        'normal_limit_min_clip': 1000,
        'soft_be_urgency': 1.2,
        'soft_be_slippage': 0.02,
        'soft_be_batch_fraction': 0.35,
        'marketable_limit_eps': 0.01,
    },
    # Heat 4
    # WDY: high liquidity / medium vol -> unwind faster, tolerate price drift.
    'WDY': {
        'risk_mult': 1.2,
        'base_participation': 0.12,
        'max_participation': 0.35,
    ...
    # BZZ: medium liquidity / high vol -> unwind faster, more aggressive.
    'BZZ': {
        'risk_mult': 1.3,
        'base_participation': 0.15,
        'max_participation': 0.35,
    ...
    # BNN: medium liquidity / medium vol -> balanced approach.
    'BNN': {
        'risk_mult': 1.0,
        'base_participation': 0.10,
        'max_participation': 0.28,
    ...
    # Heat 5
    # VNS: medium liquidity / high vol -> unwind faster, more aggressive.
    'VNS': {
        'risk_mult': 1.3,
        'base_participation': 0.15,
        'max_participation': 0.35,
    ...
    # MRS: high liquidity / medium vol -> unwind faster, tolerate price drift.
    'MRS': {
        'risk_mult': 1.2,
        'base_participation': 0.12,
        'max_participation': 0.35,
    ...
    # JPTR: medium liquidity / low vol -> unwind smooth, strict on price.
    'JPTR': {
        'risk_mult': 0.8,
        'base_participation': 0.06,
        'max_participation': 0.22,
    ...
    # STRN: medium liquidity / high vol -> unwind faster, more aggressive.
    'STRN': {
        'risk_mult': 1.3,
        'base_participation': 0.15,
        'max_participation': 0.35,
